from routes.user_routes import UserResource, UserByIdResource
# from server.routes.transaction_routes import TransactionsResource, TransactionByIdResource
# from server.routes.wallet_routes import WalletsResource, WalletByIdResource
...
def register_routes(api):
    ...
    api.add_resource(UserByIdResource, '/api/users/<string:user_id>')  # Changed to string for Clerk IDs
